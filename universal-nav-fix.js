(function () {
  if (document.querySelector('.sw7-universal-header')) return;
  {
    ...
    fallbackStyle.textContent = `
      ...
      @media(min-width:901px){.sw7-clean-nav>a,.sw7-clean-item{transition:background-color .18s ease!important}.sw7-clean-nav>a:hover,.sw7-clean-nav>a:focus-visible,.sw7-clean-item:hover,.sw7-clean-item:focus-within{background:#eef6ff!important}.sw7-clean-nav>a:hover,.sw7-clean-nav>a:focus-visible,.sw7-clean-item:hover>.sw7-clean-trigger,.sw7-clean-item:focus-within>.sw7-clean-trigger{color:#0784ff!important}.sw7-clean-menu a:hover,.sw7-clean-menu a:focus-visible,.sw7-clean-sub>button:hover,.sw7-clean-sub>button:focus-visible{background:#dceeff!important}.sw7-website-group>.sw7-clean-submenu a:hover,.sw7-website-group>.sw7-clean-submenu a:focus-visible{color:#0784ff!important}.sw7-seo-group>.sw7-clean-submenu a:hover,.sw7-seo-group>.sw7-clean-submenu a:focus-visible{color:#00a978!important}}
      .sw7-clean-menu{position:absolute!important;z-index:2147483001!important;top:64px!important;left:0!important;min-width:270px!important;padding:10px!important;background:#f4f3ef!important;box-shadow:0 20px 50px rgba(0,0,0,.2)!important;opacity:0!important;visibility:hidden!important;transform:translateY(8px)!important}.sw7-contact-item>.sw7-clean-menu{left:auto!important;right:0!important;min-width:210px!important}.sw7-clean-item:hover>.sw7-clean-menu,.sw7-clean-item:focus-within>.sw7-clean-menu,.sw7-clean-item.open>.sw7-clean-menu{opacity:1!important;visibility:visible!important;transform:none!important}
      .sw7-clean-menu a,.sw7-clean-sub>button{display:flex!important;align-items:center!important;justify-content:space-between!important;width:100%!important;padding:13px 14px!important;border:0!important;background:transparent!important;color:#111!important;text-decoration:none!important;font:800 12px/1.2 Arial!important;letter-spacing:.04em!important;box-sizing:border-box!important;cursor:pointer!important}.sw7-clean-sub{position:relative!important}.sw7-clean-sub>button.website{color:#0784ff!important;border-left:4px solid #0784ff!important}.sw7-clean-sub>button.seo{color:#00a978!important;border-left:4px solid #00a978!important}.sw7-clean-submenu{position:static!important;display:none!important;min-width:0!important;padding:0 0 6px 15px!important;background:#fff!important;box-shadow:none!important;opacity:1!important;visibility:visible!important;transform:none!important}.sw7-clean-sub:hover>.sw7-clean-submenu,.sw7-clean-sub:focus-within>.sw7-clean-submenu,.sw7-clean-sub.open>.sw7-clean-submenu{display:block!important}
      .sw7-sitewide-disclaimer{display:block!important;width:100%!important;margin:0!important;padding:16px 20px!important;background:#111!important;color:#9da5af!important;text-align:center!important;font:500 10px/1.5 Arial,Helvetica,sans-serif!important;letter-spacing:.01em!important;box-sizing:border-box!important}
    ...
    const disclaimerText = 'SEO, AEO, ranking, traffic, lead, customer, revenue, and profit results are not guaranteed. Any projections or examples shown are illustrative only and do not represent live Google data. Actual results vary by business, market, competition, strategy, and lead conversion.';
    const copyrightLine = [...document.querySelectorAll('body *')].find(function (element) {
      return element.children.length === 0 && /all rights reserved/i.test(element.textContent || '');
    });
    if (copyrightLine && !document.querySelector('.sw7-sitewide-disclaimer')) {
      const sitewideDisclaimer = document.createElement('div');
      sitewideDisclaimer.className = 'sw7-sitewide-disclaimer';
      sitewideDisclaimer.textContent = disclaimerText;
      copyrightLine.parentNode.insertBefore(sitewideDisclaimer, copyrightLine);
    }
