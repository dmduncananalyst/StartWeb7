(function () {
  ...
  var scenes = {
    ...
    'med-spas.html': '<div class="medspa-live"><div class="medspa-head"><small>TREATMENT TO APPOINTMENT</small><strong>CHOOSE. REVIEW. BOOK.</strong></div><div class="medspa-flow"><div class="medspa-treatments"><b>CONCERN</b><button class="selected">FINE LINES</button><button>SKIN TEXTURE</button><button>VOLUME</button></div><div class="medspa-arrow">→</div><div class="medspa-times"><b>AVAILABLE TIMES</b><span>10:00</span><span class="selected">11:30</span><span>1:00</span><button>REQUEST APPOINTMENT</button></div></div><div class="medspa-confirm">✓ APPOINTMENT REQUEST READY</div></div>',
    'cosmetic-clinics.html': '<div class="clinic-live"><div class="clinic-head"><small>PROCEDURE RESEARCH</small><strong>COMPARE BEFORE CHOOSING.</strong></div><div class="clinic-compare"><div><b>PROCEDURE A</b><span>✓ Candidacy</span><span>✓ Recovery</span><span>✓ Expected process</span></div><div class="active"><b>PROCEDURE B</b><span>✓ Candidacy</span><span>✓ Recovery</span><span>✓ Expected process</span></div></div><div class="clinic-provider"><i></i><p><b>BOARD-CERTIFIED PROVIDER</b><span>Credentials · Experience · Consultation</span></p><button>REVIEW DETAILS</button></div></div>'
  };
